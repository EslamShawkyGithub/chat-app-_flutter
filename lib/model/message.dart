...
final User jan =
User(id: 8, name: 'jan', imageUrl: 'assets/images/jan.jpeg');
final User mark =
User(id: 9, name: 'mark', imageUrl: 'assets/images/mark.jpeg');

final User owen =
User(id: 10, name: 'owen', imageUrl: 'assets/images/owen.jpg');
final User perllo =
User(id: 11, name: 'perllo', imageUrl: 'assets/images/perllo.jpg');

final User raan =
User(id: 12, name: 'raan', imageUrl: 'assets/images/raan.jpg');

final User sara =
User(id: 13, name: 'sara', imageUrl: 'assets/images/sara.jpg');
// FAVORITE CONTACTS
